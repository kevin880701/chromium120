...
_IGNORE_WARNINGS = (
    ...
    r'Warning: InnerClasses attribute has entries missing a corresponding EnclosingMethod attribute. Such InnerClasses attribute entries are ignored',  # pylint: disable=line-too-long
    # Warning in obj/third_party/android_deps/google_play_services_measurement_java/classes.jar:com/google/android/gms/measurement/internal/zzfh$zza.class:  # pylint: disable=line-too-long
    # Classes with missing EnclosingMethod: com.google.android.gms.measurement.internal.zzfh$zza  # pylint: disable=line-too-long
