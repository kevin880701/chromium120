...
import org.chromium.base.local_proxy.NetworkingProtectorManager;
import org.chromium.base.local_proxy.ProtectorService;
...
public class ChromeTabbedActivity extends ChromeActivity<ChromeActivityComponent> {
    ...
    private Boolean mProtectorServiceBound = false;
    ProtectorService.LocalBinder mProtectorServiceBinder;

    private final ServiceConnection mServiceConnection = new ServiceConnection(){
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            mProtectorServiceBinder = (ProtectorService.LocalBinder) iBinder;
            mProtectorServiceBound = true;
        }

        @Override
        public void onServiceDisconnected(ComponentName componentName) {
            mProtectorServiceBound = false;
            mProtectorServiceBinder = null;
        }
    };
    ...
    public void onStartWithNative() {
        ...
        if (!mProtectorServiceBound) {
            Intent intent = new Intent(getApplicationContext(), ProtectorService.class);
    ...
    private void createInitialTab() {
        ...
        if (!shouldShowOverviewPageOnStart) {
            GURL homepageGurl = new GURL(url);
